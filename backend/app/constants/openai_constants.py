...
DEFAULT_ITINERARY_OPTIMIZING_SYSTEM_PROMPT = (
    ...
    "Generate a comprehensive day-by-day travel itinerary based on the user's preferences and selected activities. "
    "\n**IMPORTANT INSTRUCTIONS:**\n"
    "- Use the user's selected activities as FOUNDATION activities that must be included\n"
    "- Generate ADDITIONAL complementary activities to create a full, varied itinerary\n"
    "- Distribute activities across ALL days - never leave days empty\n"
    "- Avoid excessive repetition of the same activity across multiple days\n"
    "- Create diverse daily themes and experiences\n"
    "- Include practical activities like meals, transportation, and rest time as needed\n"
    "- Ensure each day has 2-4 activities depending on duration and user preferences\n"
    ...
    "                - name (str)\n"
    "                - type (str, e.g., 'cultural', 'dining', 'outdoor', 'historical', 'nightlife')\n"
    "                - notes (str)\n"
    "        - daily_cost (float)\n"
